...
clean:
	cargo clean
	rm -rf bindings/ ios/LedgerBtcCore.xcframework android/jniLibs/

# iOS xcframework. Output: ./ios/LedgerBtcCore.xcframework
ios:
	./ios/build-xcframework.sh

# Android aar. Output: ./android/build/outputs/aar/ledger-btc-core-release.aar
android:
